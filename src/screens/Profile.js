...
function Profile() {
    ...
    return (
        ...
        <div style={{display:"flex",flex:7,flexDirection:"column",height:"100vh",overflowY:"auto"}}>
            {/* <div style={{display:"flex",justifyContent:"flex-end"}}><Button variant="contained">+</Button></div> */}
         ...
         <div style={{display:"flex",justifyContent:"space-evenly",height:"30vh"}}>
             ...
             {display.map(post=>{
                 return(
                     <div style={{display:"flex",backgroundColor:"whitesmoke",width:"50%",justifyContent:"center",overflowY:"auto"}}>
                    ...
                    <Button disabled={!uname + !uemail + !upassword + !uage + !uphone + !ucity +!ucountry} type="button" variant="contained" color="primary" onClick={updateUser} >
                        Update user
                         ...
                         <Button size="small" color="secondary" onClick={()=>deleteOpen(post.id)} variant="contained">{<DeleteIcon />}</Button>
                <Dialog open={dopen} onClose={deleteClose}>
